...
class DARKSOULSCAMERA_API UDSLockArmComponent : public USpringArmComponent
{
	GENERATED_BODY()
        ...
        //TODO 0: Study the variables for the UDSLockArmComponent, this is where the main control of the Camera takes place
public:	
    ...
    /*Switch to toggle the Camera between a hard lock and soft lock, Hard lock is set by pressing the middle mouse button, soft lock is a software lock where the software decides which target to lock on to*/
	UPROPERTY(EditDefaultsOnly, Category = "Lock On Camera")
		bool bUseSoftLock;
