...
//TODO 0: Study the variables for the ADSCharacter, this is where the main control of the Camera takes place
// Read about ACharacter, It inherits from APawn. We covered APawn last semester
